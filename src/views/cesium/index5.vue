...
export default {
  ...
  mounted() {
    ...
    // 起始时间
    const start = Cesium.JulianDate.fromDate(new Date(2017, 7, 11))
    // 结束时间
    ...
    viewer.camera.flyTo({
        destination:Cesium.Cartesian3.fromDegrees(116.405419, 32.073514, 1000000)
    })
